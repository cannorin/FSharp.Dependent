...
let project = "FSharp.Dependent"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "Simulates dependent types with type-level naturals and inline functions."

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "Simulates dependent types with type-level naturals and inline functions. For example: fixed-length vector types (i.e. type-safe List.nth!)"

// List of author names (for NuGet package)
let authors = [ "cannorin" ]

// Tags for your project (for NuGet package)
let tags = "f# fsharp dependenttypes fixedlist validation"

// File system information
let solutionFile  = "FSharp.Dependent.sln"
